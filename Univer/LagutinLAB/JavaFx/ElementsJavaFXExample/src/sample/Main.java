...
//        buttonDog1.setSelected(true);
        buttonDog1.setOnAction((event) -> {
            Image imageDog = new Image(Main.class.getResourceAsStream("images/dog.jpeg"));
        ...
        buttonHouse1.setOnAction(( event) -> {
            Image imageHouse = new Image(Main.class.getResourceAsStream("images/house.jpeg"));
        ...
        buttonTree1.setOnAction((event) -> {
            Image imageTree = new Image(Main.class.getResourceAsStream("images/tree.jpeg"));
